...
func flickrResimBilgisiUrl(apiAnahtari:String,fotografId:String,secret:String)->String{
    let flickrResimBilgisiUrl="https://api.flickr.com/services/rest/?method=flickr.photos.getInfo&api_key=\(apiAnahtari)&photo_id=\(fotografId)&secret=\(secret)&format=json&nojsoncallback=1";
    return flickrResimBilgisiUrl;
}
